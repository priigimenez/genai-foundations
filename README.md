## Objetivo
Explorar fundamentos de LLMs y GenAI con foco en:
- Uso responsable de datos.
- Calidad de los outputs y de los datasets de entrenamiento.
- Trazabilidad de la información (Lineage).
- Posibles aplicaciones prácticas en Data Governance.

## Contenidos
- **Conceptos básicos de LLMs:** arquitectura, Transformers y evolución del NLP.
- **Ejemplos de prompts:** experimentos de Prompt Engineering y Few-shot prompting.
- **Primeras llamadas a APIs:** implementación técnica usando Vertex AI (GCP).
- **Reflexiones sobre riesgos y control del dato:** análisis de sesgos, privacidad y seguridad.
